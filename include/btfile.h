...
class BTreeFile: public IndexFile{
  ...
  public:
    ...
    Status halfNode(PageId prevPageID, BTLeafPage* prevPage, void* &prevKey, PageId& newPageID,
        		BTLeafPage*& newPage, void*& newkey, const void* insertkey, RID data,AttrType keytype);

    Status findLeafNode(const void* key, PageId& leafid, vector<PageId>& visitedIndexes, BTLeafPage*& leafpage);
};
